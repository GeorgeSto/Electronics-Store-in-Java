...
public class AdminRepositoryMySQL implements AdminRepository{
    ...
    public AdminRepositoryMySQL(Connection connection, RightsRolesRepository rightsRolesRepository, ElectroRepository electroRepository, UserRepository userRepository){
    ...
    public Map<User, String> findEmployeeActivity() {
        ...
        String sql = "SELECT electro_id, employee_id " +
                "FROM user_electro " +
        ...
        try {
            ...
            while (resultSet.next()) {
                long electroId = resultSet.getLong("electro_id");
                long employeeId = resultSet.getLong("employee_id");

                User employee = userRepository.findUserById(employeeId);
                String electroTitle = electroRepository.getElectroTitleById(electroId);

                activity.put(employee, electroTitle);
            }
